                        ...
                        <div className="bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[40px] p-12 shadow-2xl space-y-16 animate-in zoom-in-95 fade-in duration-500 text-left">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 px-4 py-8">
                                <ul className="space-y-0 p-0 list-none">
                                    <TimelineItem label="Pengajuan & Upload Dokumen" done={true} />
                                    <TimelineItem label="Verifikasi Arsip Fisik" done={trackingResult.current_stage !== 'Pending'} />
                                    <TimelineItem label="Pengerjaan Pemisahan" done={['Pengerjaan pemisahan', 'Perbaikan lembaran', 'Penyusunan dan perapihan', 'Duplikasi arsip', 'Penjilidan arsip', 'Alih Media', 'Selesai & Serah Terima'].includes(trackingResult.current_stage)} />
                                    <TimelineItem label="Perbaikan Lembaran" done={['Perbaikan lembaran', 'Penyusunan dan perapihan', 'Duplikasi arsip', 'Penjilidan arsip', 'Alih Media', 'Selesai & Serah Terima'].includes(trackingResult.current_stage)} />
                                    <TimelineItem label="Penyusunan dan Perapihan" done={['Penyusunan dan perapihan', 'Duplikasi arsip', 'Penjilidan arsip', 'Alih Media', 'Selesai & Serah Terima'].includes(trackingResult.current_stage)} />
                                </ul>
                                <ul className="space-y-0 p-0 list-none">
                                    <TimelineItem label="Duplikasi Arsip" done={['Duplikasi arsip', 'Penjilidan arsip', 'Alih Media', 'Selesai & Serah Terima'].includes(trackingResult.current_stage)} />
                                    <TimelineItem label="Penjilidan Arsip" done={['Penjilidan arsip', 'Alih Media', 'Selesai & Serah Terima'].includes(trackingResult.current_stage)} />
                                    <TimelineItem label="Alih Media" done={['Alih Media', 'Selesai & Serah Terima'].includes(trackingResult.current_stage)} />
                                    <TimelineItem label="Selesai & Serah Terima" done={trackingResult.current_stage === 'Selesai & Serah Terima'} />
                                </ul>
                            </div>
